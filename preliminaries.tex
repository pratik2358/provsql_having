...
We extend the defintion of semiring with a monus operation $\ominus$:
...
For the semirings in Example~\ref{ex:semirings}, the monus operation $\ominus$ is defined as follows. For $\mathbb N$, $a\ominus b = \max(a-b,0)$. For $\mathbb B$, $a\ominus b = a\land \lnot b$. For the Why-provenance semiring, $A\ominus B = A\setminus B$.
