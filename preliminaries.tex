...
\begin{definition}[m-semiring]
  An \emph{m-semiring}, denoted by $(\mathbb K,\oplus,\otimes,\ominus,\mathbb 0,\mathbb 1)$, is a semiring equipped with a binary operation $\ominus: \mathbb K\times \mathbb K\to \mathbb K$, such that $\forall a,b,c\in\mathbb K$:
  \begin{itemize}
...
Semirings can have other properties, such as:
\begin{itemize}
...
Table~\ref{tab:semirings} summarizes definition of the $\ominus$ operator and the above properties for the semirings in Example~\ref{ex:semirings} and some additional ones,  such as the Boolean function semiring, the tropical semiring, the Viterbi semiring and the \L ukasiewicz semiring. 
