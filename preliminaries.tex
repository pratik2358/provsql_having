...
\begin{definition}[Semiring]
  A \emph{semiring} is a tuple $(\mathbb K,\oplus,\otimes,\mathbb 0,\mathbb 1)$ where $\mathbb K$ is a set, $\oplus$ and $\otimes$ are binary operations on $\mathbb K$, and $\mathbb 0,\mathbb 1\in \mathbb K$, such that:
  \begin{itemize}
...
\begin{definition}[m-semiring]
  An \emph{m-semiring} is a tuple $(\mathbb K,\oplus,\otimes,\ominus,\mathbb 0,\mathbb 1)$ where $\ominus: \mathbb K\times \mathbb K\to \mathbb K$ is a binary operation, such that $\forall a,b,c\in\mathbb K$:
  \begin{itemize}
