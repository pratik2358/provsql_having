...
\begin{proposition}
There exist Boolean HAVING queries such that determining whether the provenance of these
queries in the $\mathbb{N}$ (respectively, $\mathbb{B}[X]$) is $0$
(respectively, $\bot$) is NP-complete.
\end{proposition}
\rjok{todo: propose that for boolean provenance possible world semantics matches}
