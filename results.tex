...
\begin{proof}
  \pierre{Need to replace with idempotent non-absorptive example
  \lean{Semirings/Tropical}{TropicalR.F_ne_S}}
%\lean{Semirings/Nat}{Nat.counterexample_having}
%We consider a similar setting as mentioned in Proof~\ref{proof:proof_2} but with
%$\mathbb{N}$-semiring valuation of $t_1, t_2, t_3$: $1, 1, 1$.
%\begin{align*}
%  &\angsem{\hat I}{Q^{= 2}_1}(u)=\\
%  &((1\times 1)\times(1- 1)) + ((1\times 1)\times(1-1)) + ((1\times 1)\times(1-1))\\
%  =& 0 + 0 + 0 \\
%  =& 0
%\end{align*}
%
