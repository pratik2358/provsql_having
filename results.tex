...
$\langle Q^{\op C}_1\rangle^{\hat I}\neq \langle Q^{\op C}_2\rangle^{\hat I}$.
Fix $C=2$ and $\op= \; =$.
...
Then,
\[
  \langle Q^{= 2}_1\rangle^{\hat I}=(t_1 \otimes t_2)\otimes(\mathbb{1}\ominus t_3) \oplus (t_1 \otimes t_3)\otimes(\mathbb{1}\ominus t_2)\oplus(t_2 \otimes t_3)\otimes(\mathbb{1}\ominus t_1)
\]
and,
\[
  \langle Q^{= 2}_2\rangle^{\hat I}=(t_1 \otimes t_2)\oplus (t_1 \otimes t_3)\oplus (t_2 \otimes t_3)
\]
Fix a why-semiring valuation of $t_1, t_2, t_3$: $\{\{a\}\}, \{\{b\}\}, \{\emptyset\}$.
So,
\begin{align*}
  &\langle Q^{= 2}_1\rangle^{\hat I}(u)=\\
...
But,
\begin{align*}
  &\langle Q^{= 2}_2\rangle^{\hat I}(u)=\\
  &(\{\{a\}\}\Cup\{\{b\}\})\cup(\{\{a\}\}\Cup\{\emptyset\})\cup(\{\{b\}\}\Cup\{\emptyset\})\\
  =&\{\{a, b\}\} \cup \{\{a\}\} \cup \{\{b\}\}\\
  =&\{\{a\}, \{b\}, \{a, b\}\}
\end{align*}
Hence, $\langle Q^{\op C}_1\rangle^{\hat I}\neq \langle Q^{\op C}_2\rangle^{\hat I}$.
\end{proof}
...
\begin{proposition}
  For any $\mathbb{K}$-instance of characteristic~0, there exists a Boolean \textsf{HAVING} query such that determining
...
\begin{proof}
  ...
  \cite{sen2026provsql}.
  For all operators other than \textsf{HAVING}, this is a polynomial-time
  operation. For \textsf{HAVING}, we guess (and keep only) one
