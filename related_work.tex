...
\textbf{Aggregation in the provenance semiring framework.}
...
\textbf{Negation in the provenance semiring framework.}
...
\textbf{Aggregation in probabilistic databases.}
...
polynomial time over probabilistic databases, a classification by query
shape orthogonal to Section~\ref{sec:algorithms}, which classifies
combinations of semirings and aggregates;
Proposition~\ref{prop:agg-cmp-poly-prob} addresses the comparison alone,
for independent contributors. \cite{abiteboul2011capturing} studies
...
\textbf{Aggregation over compact representations.}
