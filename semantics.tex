...
\]
\begin{theorem}
  For commutative $m-$semirings with additive 
  idempotence, provenance computation using the possible-world 
  semantics of Definition~\ref{def:pw_semantics} is equivalent to the corresponding provenance computation as described in Proposition~\ref{prop:j_rewrite}.
\end{theorem}
\begin{proof}
\end{proof}
