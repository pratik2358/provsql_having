...
\newcommand{\op}{\hspace{0.1cm}\mathsf{\star}\hspace{0.1cm}}
\makeatletter
\newcommand{\bigplus}{%
...
\begin{theorem}
  ...
  Q^{\geq C}_2&=\Pi_{\#1}(q\bowtie_{\#1=\#3\land\#2<\#4}
    q\bowtie_{\#1=\#5\land\#4<\#6}\dots\bowtie_{\#1=\#(2C+1)\land\#(2C)<\#(2C+2)}q)\\
Q^{\leq C}_2&=q-Q_2^{\geq C+1}\\
