...
\begin{proof}
  \textbf{($\Rightarrow$)}
  Assume S to be additively idempotent, then $\oplus$ is the join of a semilattice order.
  \\If $a\leq b \implies a\oplus b =b $ \text{and }$\exists x, a\oplus x=b$
  \\ $a \oplus b = a \oplus (a \oplus x)=a \oplus x = b$
  \\$a\oplus b = b \implies a \leq b$
