...
(Theorem~\ref{thm:count-enum-correct}), the valid worlds are exactly the non-empty worlds
...
(Theorem~\ref{thm:sumdp-correct}), the valid worlds are exactly the non-empty worlds
