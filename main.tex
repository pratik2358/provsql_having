...
additive monoid for aggregation. Let $*:K\times M \mapsto M$ be a scalar multiplication, such that for $a \in K, b \in M$, 
$a * b = a \times b$.

Then an aggregation expression would be of the form $\bigplus_M *(a,b)$, where $(a,b)$ resembles semimodule $K \times M$, say $\mathcal{M}$.
For any two aggregations $u,v$,

$[u \oslash v]_{\mathit{op}\in\{ =, \neq , >, <, \geq, \leq\}}: \mathcal{M} \times \{ =, \neq , >, <, \geq, \leq\} \times \mathcal{M} \rightarrow K$
...
Then for valuations, 
$w: \{1,2,\dots,m\} \mapsto K$ and $w': \{1,2,\dots,n\} \mapsto K$
